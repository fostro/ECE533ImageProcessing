...
FostroDilationFilter::FostroDilationFilter(int width, int height) : FostroFilter(width, height) {
}

FostroDilationFilter::~FostroDilationFilter() {
}

FostroImage* FostroDilationFilter::applyFilter(FostroImage* image, int c) {
	FostroPixel* pixel;
	float val = 0;
...
float FostroDilationFilter::getVal(int x, int y, FostroImage* image) {
	FostroPixel* pixel;
